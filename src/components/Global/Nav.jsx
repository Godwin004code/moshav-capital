    ...
    <>
      <header className="flex justify-between py-9 sm:py-3 w-[90%] mx-auto">
        ...
        <ul className="flex my-auto gap-12 lg:hidden">
          ...
          <li>
            <Link to="/about" className="font-medium text-lg text-white">
              About us
            </Link>
          </li>
          <li
          ...
          >
            <Link
              to="/services"
              className="font-medium text-lg text-white flex"
            >
          ...
          <li>
            <Link to="/partners" className="font-medium text-lg text-white">
              Partners
            </Link>
          </li>
          <li>
            <Link to="/contact" className="font-medium text-lg text-white">
              Contact us
            </Link>
          </li>
        </ul>

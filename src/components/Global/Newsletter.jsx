...
const Newsletter = () => {
  return (
    <section className='flex justify-between w-[90%] mx-auto py-28'>
        <div className='w-[35%]'>
            <h2 className='text-[#141414] font-semibold text-[25px]'>You Can Also Subscribe To Our Newsletter To</h2>
            <h2 className='text-[#141414] font-semibold text-[25px]'> Get Monthly Updates</h2>
        </div>

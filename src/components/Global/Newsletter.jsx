...
const Newsletter = () => {
  return (
    <section className='flex sm:flex-col justify-between w-[90%] mx-auto py-28'>
...
<input type='email' placeholder='Enter email' className='bg-transparent py-4 pl-4 w-full h-full focus:outline-none' />
            ...
            <button className='bg-[#1E772C] w-[200px] sm:mx-auto sm:mt-7 py-4 text-white text-xl rounded-[10px]'>Subscribe</button>
        </div>
    </section>
  )
}

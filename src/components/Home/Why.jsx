  ...
  return (
    <section className='py-12'>
        ...
        <div className='flex justify-between w-[90%] mt-10 mb-32 mx-auto'>
            ...
            <div className='ml-32 mr-7  mt-24'>
            ...
            <h2 className='font-extrabold text-[32px] mt-10'>02</h2>
        </div>
        <div className='flex justify-between w-[90%] mt-10 mb-32 mx-auto'>
            <h2 className='font-extrabold text-[32px] mt-10'>03</h2>
            <div className=' ml-16 mr-7 mt-24'>
        ...
        <div className='flex justify-between w-[90%] mt-10 mb-32 mx-auto'>
            ...
            <h2 className='font-extrabold text-[32px] mt-10'>04</h2>
        </div>
    </section>
  )
}

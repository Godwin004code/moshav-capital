...
<h2 className='font-semibold text-2xl text-white text-center'>Our Vision</h2>
<p className='text-white text-2xl w-[70%] mx-auto text-center mt-8'>
...
<div className='w-[2px] h-[150px] bg-white mt-5'></div>
<div className='w-[15px] h-[15px] bg-white rounded-full my-7'></div>
<div className='w-[2px] h-[150px] bg-white mb-5'></div>
<p className='text-white text-2xl w-[70%] mx-auto text-center mt-8'>
